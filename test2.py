...
create_main('test_files\\folderstruct1.txt', "output\\1", number = False)
create_main('test_files\\folderstruct2.txt', "output\\2", number = False)
create_main('test_files\\folderstruct3.txt', "output\\3", number = False)
create_main('test_files\\folderstruct4.txt', "output\\4", number = False)
